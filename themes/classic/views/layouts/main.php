...
<link href="<?php echo Yii::app()->theme->baseUrl; ?>/css/screen.css" type="text/css" rel="stylesheet" media="screen" />
...
<link href="<?php echo Yii::app()->theme->baseUrl; ?>/css/simplemodal.css" rel="stylesheet" type="text/css" />
<link href="<?php echo Yii::app()->theme->baseUrl; ?>/css/form.css" rel="stylesheet" type="text/css" />
<link href="<?php echo Yii::app()->theme->baseUrl; ?>/css/buttons.css" rel="stylesheet" type="text/css" />
<link href="<?php echo Yii::app()->theme->baseUrl; ?>/css/grid.css" rel="stylesheet" type="text/css" />
...
<body>
	<div id="wrapper" class="clearfix">
		<div id="top">
			<div id="header">
				<?php echo CHtml::link(CHtml::image(Yii::app()->theme->baseUrl."/images/celestic.png",CHtml::encode(Yii::app()->name).' v.'.Yii::app()->params['appVersion']),Yii::app()->createUrl('site'), array('title'=>CHtml::encode(Yii::app()->name).' v.'.Yii::app()->params['appVersion']));?>
					...
					<?php 
						$this->widget('application.extensions.VGGravatarWidget.VGGravatarWidget', 
							array(
								...
								'hashed' => false,
								'default' => 'http://'.$_SERVER['SERVER_NAME'].Yii::app()->theme->baseUrl.'/images/bg-avatar.png',
								'size' => 65,
								'rating' => 'PG',
					...
					<ul class="icons">
						<li>
							<a href="http://qbit.com.mx/labs/celestic" title="Celestic Homepage" rel="external">
								<?php echo CHtml::image(Yii::app()->theme->baseUrl."/favicon.png","Homepage",array('width'=>'28px','height'=>'28px'));?>
							</a>
						</li>
						<li>
							<a href="http://twitter.com/celesticMX" title="Twitter" rel="external">
								<?php echo CHtml::image(Yii::app()->theme->baseUrl."/images/sm-twitter.png","Twitter");?>
							</a>
						</li>
						<li>
							<a href="http://www.facebook.com/pages/Celestic/189892971069509" title="Facebook" rel="external">
								<?php echo CHtml::image(Yii::app()->theme->baseUrl."/images/sm-facebook.png","Facebook");?>
							</a>
						</li>
						<li>
							<a href="http://qbit.com.mx/labs/celestic/forum" title="Forum" rel="external">
								<?php echo CHtml::image(Yii::app()->theme->baseUrl."/images/vanilla.png","Forum");?>
							</a>
						</li>
						<li>
							<a href="http://qbit.com.mx/labs/celestic/blog" title="Blog" rel="external">
								<?php echo CHtml::image(Yii::app()->theme->baseUrl."/images/wordpress.png","Blog");?>
							</a>
						</li>
					</ul>
				</div>
...
Yii::app()->clientScript->registerScriptFile(Yii::app()->theme->baseUrl.'/js/jquery.highlight.js',CClientScript::POS_END);
