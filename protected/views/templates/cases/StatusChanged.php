			...
			<tbody>
				<tr>
					<td valign="top" id="maincontent" style="padding-top:15px;">
						<p>
							Traemos <?php echo $typeNews; ?> noticias para ti, <b><?php echo $user->completeName; ?></b> ha cambiado el estatus para el caso <?php echo $case->case_name; ?>.
						</p>
						<p>
							Si deseas obtener m&aacute;s informaci&oacute;n sobre este caso o el proyecto relacionado puedes seguir el siguiente enlace:<br />
							<a href="<?php echo $urlToCase; ?>" target="_blank"><?php echo $urlToCase; ?></a>
						</p>
						<p>
