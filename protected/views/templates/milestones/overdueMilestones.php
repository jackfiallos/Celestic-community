			...
			<tbody>
				<tr>
					<td valign="top" id="maincontent" style="padding-top:15px;">
						<p>
							Hola <b><?php echo $user; ?></b>, es penoso para mi, pero necesito recordarte que tienes hitos vencidos con tareas pendientes por terminar, la lista de tareas a continuaci&oacute;n: 
						</p>
						<div style="padding:5px; background-color:#DFF3FB;">
							<?php foreach ($tasks as $task):?>
							<p>
								<b>Nombre de la Tarea:</b><br />
								<?php echo CHtml::link($task->task_name, Yii::app()->createUrl('tasks/view', array('id'=>$task->task_id))); ?>&nbsp;
								[<?php echo $task->Status->status_name;?>]
							</p>
							<p>
								<b>Descripci&oacute;n:</b><br />
								<?php echo Yii::app()->format->html(nl2br($task->task_description)); ?>
							</p>
							<hr />
							<?php endforeach; ?>
						</div>
