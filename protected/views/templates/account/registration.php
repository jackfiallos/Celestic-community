			...
			<tbody>
				<tr>
					<td valign="top" id="maincontent" style="padding-top:15px;">
						...
						<p>
							<?php echo $applicationName; ?> fue desarrollado con la idea de mejorar la comunicaci&oacute;n entre los equipos de trabajo por parte del cliente y los desarrolladores, de tal manera que todos puedan mantenerse en sinton&iacute;a al momento de realizar la dif&iacute;cil tarea de planear, documentar, desarrollar y poner en marcha un proyecto de software.
						</p>
						<div style="padding:5px; background-color:#DFF3FB;">
							<p>
								Tus datos de acceso ser&aacute;n los siguientes:
							</p>
							<p>
								Nombre de usuario: <?php echo $user->user_email; ?><br />
								Clave de Acceso: <?php echo $passBeforeMD5; ?>
							</p>
							<p>
								<?php echo CHtml::link("Sigue este enlace para activar tu cuenta",Yii::app()->createAbsoluteUrl('site/signsucess', array("uid"=>$user->user_id,"uauth"=>md5($user->user_email),"tauth"=>sha1(substr($user->user_password, -1))))); ?>
							</p>
						</div>
						<p>
							Atentamente,
