			...
			<tbody>
				<tr>
					<td valign="top" id="maincontent" style="padding-top:15px;">
						<p>
							Nuevamente traigo noticias para t&iacute;, ahora relacionadas al proyecto <b><?php echo $task->Projects->project_name; ?></b>.
						</p>
						<div style="padding:5px; background-color:#DFF3FB;">
							<p>
								<u><?php echo $username; ?></u> ha cambiado el estatus de la tarea <b><?php echo $task->task_name; ?></b>, esta vez ha sido marcada como <b><?php echo $task->Status->status_name; ?></b>.
							</p>
							<p>
