			...
			<tbody>
				<tr>
					<td valign="top" id="maincontent" style="padding-top:15px;">
						<p>Hey que crees, una tarea para el proyecto <b><?php echo $task->Projects->project_name; ?></b> te fue asignada y es requerido que la valides y cambies su estado cuando ya la hayas resuelto.</p>
						<div style="padding:5px; background-color:#DFF3FB;">
							<p>
								<b>Tarea:</b><br /><?php echo $task->task_name; ?><br /><br />
								<b>Descripci&oacute;n:</b><br /><?php echo Yii::app()->format->html(nl2br($task->task_description)); ?><br /><br />
								Para ver m&aacute;s detalles puedes ir directamente a este enlace: <a href="<?php echo $task_url; ?>" title="<?php echo $task->task_name; ?>"><?php echo $task_url; ?></a>
							</p>
						</div>
						<p>
